#
#  Be sure to run `pod spec lint AUIInteractionLiveDemo.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  #   * Finally, don't worry about the indent, CocoaPods strips it!
   spec.description  = <<-DESC
                      GX Common GXPay, including GXPay etc
                      DESC

  spec.homepage     = "https://github.com/LiRuiTao/LiveProject.git"
  ...
  spec.source       = { :git => "https://github.com/LiRuiTao/LiveProject.git", :tag => "#{spec.version}" }
  ...
  spec.dependency "AlivcInteraction", "~> 1.2.0"
